...
w = Tk()
w.geometry("1366x768")
w.iconphoto(False, PhotoImage(file=r"download.png"))
w.state('zoomed')
w.resizable(0,0)
canvas = Canvas(w, width = 1366, height = 768, bg = 'black')
canvas.pack(expand = YES, fill = BOTH)
image1 = ImageTk.PhotoImage(file = r"Image_20221229_184443_088.png.png")
canvas.create_image(0, 0, image = image1, anchor = NW)


# photox=PhotoImage(file = r"PNG Formant.png")
# back=Button(w, image=photox, compound = TOP,width=100,height=10)
# back.image=photox
...
def burger():
    ...
    photox=PhotoImage(file = r"backbutton.png")
    back=Button(t, image=photox, compound = TOP, command=t.withdraw)
    back.image=photox
    ############################################################################################################################################
    back.place(x=1210,y=15)
    
    
    photoy=PhotoImage(file = r"printbill.png")
    back=Button(t, image=photoy, compound = TOP, command=newwindow)
    back.image=photoy
...
#     
    ...
    t.iconphoto(False, PhotoImage(file=r"download.png"))
    t.title("Burger")
        ...
        try:
            ...
            for i in list_of_intents:
                if i['tag']  == tag:
                    ...
                    if tag=='shack burger':
                        Shackburger()
                    if tag=='shroom burger':
                        Shroomburger()
                    if tag=='smoke shack':
                        Smokeshack()
                    if tag=='stack shack':
                        Stackshack()
                    if tag=='cheese burger':
                        Cheeseburger()
                    if tag=='hamburger':
                        Hamburger()
                    if tag=='chick n shack':
                        Chicknshack()
                    if tag=='chipotle chicken':
                        Chipotlecheddarchicken()
                    if tag=='bill':
                        newwindow()
                    break
        except IndexError:
...
#         while True:
        ...
        try:
            with sr.Microphone() as source2:
                ...
                input_data = r.recognize_google(audio2)
                input_data = input_data.lower()
                print(input_data)
                ints = _predict_class(input_data)
            ...
            Label(f,text="Unable to listen",fg='white', bg='red').place(x=10,y=10)
            print("unknown error occurred")
            SpeakText("unable to listen")
...
#                 
#                 if MyText=='shackburger'or MyText=='Shack'or MyText=='normal':
#                     Shackburger()
#                 elif MyText=='shroomburger'or MyText=='shroom':
#                     Shroomburger()
#                 elif MyText=='smokeshack'or MyText=='smoke'or MyText=='shack':
#                     Smokeshack()
#                 elif MyText=='stackshack'or MyText=='stack':
#                     Stackshack()
#                 elif MyText=='cheeseburger'or MyText=='cheese':
#                     Cheeseburger()
#                 elif MyText=='hamburger'or MyText=='ham burger'or MyText=='ham':
#                     Hamburger()
#                 elif MyText=='chick n shack'or MyText=='chick'or MyText=='bacon':
#                     Chicknshack()
#                 elif MyText=='chipotle chicken'or MyText=='chipotle'or MyText=='chicken':
#                     Chipotlecheddarchicken()
#                 elif MyText=='print':
#                     newwindow()
# 
#                 else:
#                     print("!!!!!!!!!!!!!")
#                 Label(t,text="You speak...",fg='white', bg='gray',width=20).place(x=10,y=10)
#                 Label(t,text=MyText,fg='white', bg='gray',width=20).place(x=10,y=30)
#                 SpeakText("Did you say")
#                 SpeakText(MyText)
#         except sr.RequestError as e:
#             print("Could not request results; {0}".format(e))
#         except sr.UnknownValueError:
#             Label(t,text="Unable to listen",fg='white', bg='red').place(x=10,y=10)
#             print("unknown error occurred")
    
    mic=PhotoImage(file = r"3f41c207e196930f70d6208a31fac11c.png")
    mic1=Button(t, image=mic, compound = TOP,width=50,height=50,bg="black",border=0,activebackground="black",command=voice)
    mic1.image=mic
    mic1.place(x=1225,y=625)
...
def Fries():
    ...
    photo1 = PhotoImage(file = r"normal fries.png")
    b1=Button(t, text = 'Normal Fries', image = photo1, font='LITHOGRAPH', compound = TOP, command=normalfries)
    b1.image=photo1
    b1.place(x=200,y=200)
    photo2 = PhotoImage(file = r"cheese fries.png")
    b2=Button(t, text = 'cheese fries', image = photo2, font='LITHOGRAPH', compound = TOP, command=cheesefries)
    b2.image=photo2
    b2.place(x=500,y=200)
    photo3 = PhotoImage(file = r"veal bacon and cheese fries.png")
    b3=Button(t, text = 'Bacon & Cheese', image = photo3, font='LITHOGRAPH', compound = TOP, command=vealbaconandcheesefries)
    b3.image=photo3
        ...
        try:
            ...
            for i in list_of_intents:
                if i['tag']  == tag:
                    ...
                    if tag=='cheese fries':
                        cheesefries()
                    if tag=='bacon and cheese':
                        vealbaconandcheesefries()
                    if tag=='bill':
                        newwindow()
                    break
        except IndexError:
...
#                 print("Did you say ",MyText)
#                 
#                 if MyText=='normalfries'or MyText=='normal fries'or MyText=='normal'or MyText=='marble price':
#                     normalfries()
#                 elif MyText=='cheesefries'or MyText=='cheese fries'or MyText=='cheese':
#                     cheesefries()
#                 elif MyText=='baconandcheese'or MyText=='bacon and cheese'or MyText=='bacon':
#                     vealbaconandcheesefries()
#                 elif MyText=='print':
#                     newwindow()
# 
...
def Shakes():
    ...
    photo1 = PhotoImage(file = r"cinnamon soul.png")
    b1=Button(t, text = 'Cinnamon Soul', image = photo1, font='LITHOGRAPH', compound = TOP, command=cinnamonsoul)
    b1.image=photo1
    b1.place(x=300,y=200)
    
    photo2 = PhotoImage(file = r"black and white.png")
    b2=Button(t, text = 'black and white', image = photo2, font='LITHOGRAPH', compound = TOP, command=blackandwhite)
    b2.image=photo2
        ...
        try:
            ...
            for i in list_of_intents:
                if i['tag']  == tag:
                    ...
                    if tag=='cinnamon soul':
                        cinnamonsoul()
                    if tag=='black and white':
                        blackandwhite()
                    if tag=='bill':
                        newwindow()
                    break
...
#                 print("Did you say ",MyText)
#                 
#                 if MyText=='cinnamonsoul'or MyText=='cinnamon soul'or MyText=='cinnamon'or MyText=='soul'or MyText=='mensol':
#                     cinnamonsoul()
#                 elif MyText=='black and white'or MyText=='black'or MyText=='white':
#                     blackandwhite()
#                 elif MyText=='print':
#                     newwindow()
# 
...
def Hotdog():
    ...
    photo1 = PhotoImage(file = r"cheese hotdog.png")
    b1=Button(t, text = 'Cheese Hotdog', image = photo1, font='LITHOGRAPH', compound = TOP, command=cheesehotdog)
    b1.image=photo1
    b1.place(x=200,y=200)
    photo2 = PhotoImage(file = r"new york style hotdog.png")
    b2=Button(t, text = 'NY Style Hotdog', image = photo2, font='LITHOGRAPH', compound = TOP, command=newyorkstylehotdog)
    b2.image=photo2
    b2.place(x=500,y=200)
    photo3 = PhotoImage(file = r"shack-cago hot dog.png")
    b3=Button(t, text = 'Shack-Cago HD', image = photo3, font='LITHOGRAPH', compound = TOP, command=shackcagohotdog)
    b3.image=photo3
    b3.place(x=800,y=200)
    t.iconphoto(False, PhotoImage(file=r"download.png"))
    t.title("Hotdog")
        ...
        try:
            ...
            for i in list_of_intents:
                if i['tag']  == tag:
                    ...
                    if tag=='cheese hotdog':
                        cheesehotdog()
                    if tag=='ny style hotdog':
                        newyorkstylehotdog()
                    if tag=='shack cago hotdog':
                        shackcagohotdog()
                    if tag=='bill':
                        newwindow()
                    break
...
#                 print("Did you say ",MyText)
#                 
#                 if MyText=='cheesehotdog'or MyText=='cheese hot dog':
#                     cheesehotdog()
#                 elif MyText=='nystylehotdog'or MyText=='ny style hot dog'or MyText=='ny style':
#                     newyorkstylehotdog()
#                 elif MyText=='shackcagohotdog'or MyText=='shack cago hd'or MyText=='shack cago':
#                     shackcagohotdog()
#                 elif MyText=='print':
#                     newwindow()
# 
...
def Drinks():
    ...
    photo1 = PhotoImage(file = r"fresh brewed ice tea.png")
    b1=Button(t, text = 'Ice Tea', image = photo1, font='LITHOGRAPH', compound = TOP, command=freshbrewedicetea)
    b1.image=photo1
    b1.place(x=100,y=200)
    photo2 = PhotoImage(file = r"float bottled water.png")
    b2=Button(t, text = 'Float Water', image = photo2, font='LITHOGRAPH', compound = TOP, command=floatbottledwater)
    b2.image=photo2
    b2.place(x=400,y=200)
    photo3 = PhotoImage(file = r"fiftyfifty.png")
    b3=Button(t, text = 'Fifty-Fifty', image = photo3, font='LITHOGRAPH', compound = TOP, command=fiftyfifty)
    b3.image=photo3
    b3.place(x=700,y=200)
    photo4 = PhotoImage(file = r"shack-made lemonade.png")
    b4=Button(t, text = 'Shack Lemonade', image = photo4, font='LITHOGRAPH', compound = TOP, command=shackmadelemonade)
    b4.image=photo4
...
#                 print("Did you say ",MyText)
#                 
#                 if MyText=='icetea'or MyText=='ice tea':
#                     freshbrewedicetea()
#                 elif MyText=='float bottle water'or MyText=='bottle'or MyText=='water':
#                     floatbottledwater()
#                 elif MyText=='fiftyfifty'or MyText=='fifty fifty':
#                     fiftyfifty()
#                 elif MyText=='shacklemonade'or MyText=='shack lemonade'or MyText=='lemonade':
#                     shackmadelemonade()
#                 elif MyText=='print':
#                     newwindow()
# 
...
def IceCream():
    ...
    photo1 = PhotoImage(file = r"shack attack.png")
    b1=Button(t, text = 'Shack Attack', image = photo1, font='LITHOGRAPH', compound = TOP, command=shackattack)
    b1.image=photo1
    b1.place(x=100,y=120)
    photo2 = PhotoImage(file = r"vanilla.png")
    b2=Button(t, text = 'Vanilla', image = photo2, font='LITHOGRAPH', compound = TOP, command=vanilla)
    b2.image=photo2
    b2.place(x=400,y=120)
    photo3 = PhotoImage(file = r"vanilla toffee twirl.png")
    b3=Button(t, text = 'Vnilla Tfee Twirl', image = photo3, font='LITHOGRAPH', compound = TOP, command=vanillatoffeetwirl)
    b3.image=photo3
    b3.place(x=700,y=120)
    photo4 = PhotoImage(file = r"strawberry bannana trifle.png")
    b4=Button(t, text = 'B N B Trifle', image = photo4, font='LITHOGRAPH', compound = TOP, command=strawberrybannanatrifle)
    b4.image=photo4
    b4.place(x=1000,y=120)
    photo5 = PhotoImage(file = r"peanut butter.png")
    b5=Button(t, text = 'Peanut Butter', image = photo5, font='LITHOGRAPH', compound = TOP, command=peanutbutter)
    b5.image=photo5
    b5.place(x=250,y=370)
    photo6 = PhotoImage(file = r"chocolate.png")
    b6=Button(t, text = 'Chocolate', image = photo6, font='LITHOGRAPH', compound = TOP, command=chocolate)
    b6.image=photo6
    b6.place(x=550,y=370)
    photo7 = PhotoImage(file = r"dubai malt.png")
    b7=Button(t, text = 'Dubai Malt', image = photo7, font='LITHOGRAPH', compound = TOP, command=dubaimalt)
    b7.image=photo7
    b7.place(x=900,y=370)
    t.iconphoto(False, PhotoImage(file=r"download.png"))
    t.title("IceCream")
    ...
    def _get_response(ints, intents_json):
        try:
            ...
            for i in list_of_intents:
                ...
                if tag=='shackattack'or tag=='shack attack':
                    shackattack()
                if tag=='vanilla' or tag=='vennela':
                    vanilla()
                if tag=='vanilla toffee twirl'or tag=='vanilla toffee twirl':
                    vanillatoffeetwirl()
                if tag=='bnb triffle':
                    strawberrybannanatrifle()
                if tag=='peanutbutter'or tag=='peanut butter':
                    peanutbutter()
                if tag=='chocolate'or tag=='chocolates':
                    chocolate()
                    break
                if tag=='dubai malt'or tag=='dubaimalt'or tag=='dubai'or tag=='malt':
                    dubaimalt()
                if tag=='bill':
                    newwindow()
...
#                 print("Did you say ",MyText)
#                 
#                 if MyText=='shackattack'or 'MyText==shack attack':
#                     shackattack()
#                 elif MyText=='vanilla' or MyText=='vennela':
#                     vanilla()
#                 elif MyText=='vanillatoffeetwirl'or MyText=='vanilla toffee twirl':
#                     vanillatoffeetwirl()
#                 elif MyText=='strawberrybannanatrifle'or MyText=='strawberry bannana trifle':
#                     strawberrybannanatrifle()
#                 elif MyText=='peanutbutter'or MyText=='peanut butter':
#                     peanutbutter()
#                 elif MyText=='chocolate'or MyText=='chocolates':
#                     chocolate()
#                 elif MyText=='dubai malt'or MyText=='dubaimalt'or MyText=='dubai'or MyText=='malt':
#                     dubaimalt()
#                 elif MyText=='print':
#                     newwindow()
#                 
...
def check():
    name=entry1.get()
    phoneNo=entry2.get()
    inputlocation=entry3.get()
    if(name=="" and phoneNo=="" and inputlocation==""):
...
def newwindow():
    ...
    root.heading = Label(root, text="D e a t i l s",font=('LITHOGRAPH 20'),justify='center',fg='white', bg='black',width=23)
    root.heading.place(y=10)
    
    Label(root,text="Enter your Name",fg='white', bg='black',font=('LITHOGRAPH')).place(x=20,y=100)
    Label(root,text="Enter your Phone no",fg='white', bg='black',font=('LITHOGRAPH')).place(x=20,y=150)
    Label(root,text="Enter your Location",fg='white', bg='black',font=('LITHOGRAPH')).place(x=20,y=200)
    options = ["gulshan-e-iqbal block 5","gulshan-e-iqbal block 6","gulshan-e-iqbal block 7","clifton","defence","zamzama"]
    
    entry3 = StringVar(root,"Location")
    drop = OptionMenu( root , entry3 , *options )
    drop.place(x=210,y=200)
    ...
    Button(root,text="Proceed to Checkout",font='LITHOGRAPH',command=check,height=1,width=18,bd=6,fg='white', bg='black').place(x=130,y=290)
    root.mainloop()
...
#     ts.geometry("420x299")
#     ts.resizable(0,0)
#     ts.iconphoto(False, PhotoImage(file=r"download.png"))
#     ts['bg']='black'
#     
#     photoy=PhotoImage(file = r"6cb7fce502026c0b455586ea9e0b4a9f.png")
#     back=Label(ts, image=photoy)
#     back.image=photoy
#     back.pack()
...
##########################################################################################################################  
    ...
    Label(ts,text="Project Created",bg='black',fg='deeppink',font=('Wide Latin', 21)).place(x=10,y=10)
    Label(ts,text="By",bg='black',fg='deeppink',font=('Wide Latin', 21)).place(x=150,y=40)
    Label(ts,text="Nida Hassan",fg='white', bg='black',font=('Script MT Bold', 14)).place(x=20,y=80)
    Label(ts,text="",fg='white', bg='black',font=('Script MT Bold', 14)).place(x=20,y=80)
...
def recommadation():
    def valueRecommadation():
        ...
        rating = pd.read_csv("ratingss.csv", encoding='latin-1')
        food= pd.read_csv("foodss.csv", encoding='latin-1')
        dataset = rating.pivot_table(index='Food_ID',columns='User_ID',values='Rating')
        ...
        display = food_recommendation(foods)
        print(display)
        Label(root,text=display,font=('LITHOGRAPH'),fg="red",bg="black").place(y=250)
    
    root=Tk()
    root.title("Deatils")
    root.geometry("400x488")
    root['bg']='black'
    ...
    Label(root,text=" Recommendations",font=('Vladimir Script',40,'bold'),fg="gray",bg="black").place(x=15,y=10)
    
    Label(root,text="What you want to order",fg='white', bg='black',font=('LITHOGRAPH')).place(x=20,y=100)
    Label(root,text="How best do you want",fg='white', bg='black',font=('LITHOGRAPH')).place(x=20,y=150)
    
    var1 = StringVar(root, "1")  
    Radiobutton(root, text="1", variable=var1, value="1").place(x=230,y=150)
    Radiobutton(root, text="5", variable=var1, value="5").place(x=280,y=150)
    Radiobutton(root, text="10", variable=var1, value="10").place(x=330,y=150)
    
    entry1=Entry(root,bd=5)
    entry1.place(x=250,y=100)
    Button(root, text='O k a y',command=valueRecommadation,fg='white', bg='black',font=('Vivaldi')).place(x=263,y=200)
...
def fun():
    ...
    f.state('zoomed')
    f['bg']='black'
    f.iconphoto(False, PhotoImage(file=r"download.png"))
    f.resizable(0,0)
    f.focus_set()
    ...
    f.heading = Label(f, text="M E N U",font=('Ravie 40'),fg='red', bg='black',width=19,justify='center').pack()
    f.heading = Label(f, text="order  food  you  love",font=('Vivaldi 25'),fg='pink', bg='black',width=19,justify='center').pack()

    
    Label(f,text="Do you want some recomenadtion",fg='white', bg='black',font=('LITHOGRAPH')).place(x=970,y=10)
    var1 = IntVar()
    Checkbutton(f, variable=var1,command=recommadation,bg='black').place(x=940,y=10)
    
    photo11 = PhotoImage(name="burger",file = r"Chick n shack.png")
    burgers=Button(f, text = 'Burger', image = photo11,height=240, width=200,bg='black', fg='white', font=('LITHOGRAPH'), compound = TOP,command=burger)
    burgers.image=photo11
    burgers.place(x=150,y=120)
    
    photo22 = PhotoImage(name="hotdog",file = r"cheese hotdog.png")
    hotdog=Button(f, text = 'Hotdog', image = photo22,height=240, width=200,bg='black',justify='center', fg='white', font=('LITHOGRAPH'), compound = TOP,command=Hotdog)
    hotdog.image=photo22
    hotdog.pack()

    photo33 = PhotoImage(file = r"normal fries.png")
    fries=Button(f, text = 'Fries',image=photo33,height=240, width=200,bg='black',fg='white', font=('LITHOGRAPH'), compound = TOP,command=Fries)
    fries.image=photo33
    fries.place(x=950,y=120)
    
    photo55 = PhotoImage(file = r"fresh brewed ice tea.png")
    drinks=Button(f, text = 'Drinks', image=photo55,height=240, width=200,bg='black', fg='white', font=('LITHOGRAPH'), compound = TOP,command=Drinks)
    drinks.image=photo55
    drinks.place(x=150,y=400)
 
    photo44 = PhotoImage(file = r"chocolate.png")
    icecream=Button(f, text='Ice Cream',image=photo44,height=240, width=210,bg='black', fg='white', font=('LITHOGRAPH'), compound = TOP,command=IceCream)
    icecream.image=photo44
    icecream.place(x=535,y=400)
  
 
    photo66 = PhotoImage(file = r"cinnamon soul.png")
    shakes=Button(f, text = 'Shakes', image = photo66,height=240, width=200,bg='black', fg='white', font=('LITHOGRAPH'), compound = TOP,command=Shakes)
    shakes.image=photo66
    shakes.place(x=950,y=400)
...
#                     print(tag)    
                    ...
                    if tag =='burger':
                        burger()
                        print(tag) 
                    elif tag =='hotdog'or tag=='hot dog':
                        Hotdog()
                    elif tag =='frie'or tag=='fries'or  tag=='french fries'or  tag=='price':
                        Fries()
                    elif tag =='drink':
                        Drinks()
                    elif tag =='icecream'or tag=='ice cream'or tag=='cream'or tag=='ice':
                        IceCream()
                    if tag =='shake'or tag=='shakes'or tag=='check'or tag=='sheikh':
                        Shakes()
...
#                 if MyText=='burger':
#                     burger()
#                 elif MyText=='hotdog'or MyText=='hot dog':
#                     Hotdog()
#                 elif MyText=='frie'or MyText=='fries'or  MyText=='french fries'or  MyText=='price':
#                     Fries()
#                 elif MyText=='drink':
#                     Drinks()
#                 elif MyText=='icecream'or MyText=='ice cream'or MyText=='cream'or MyText=='ice':
#                     IceCream()
#                 elif MyText=='shake'or MyText=='shakes'or MyText=='check'or MyText=='sheikh':
#                     Shakes()
#                 elif MyText=='recommendation':
#                     recommadation()
# 
#                 else:
#                     print("!!!!!!!!!!!!!")
#                 Label(f,text="You speak...",fg='white', bg='gray',width=20).place(x=10,y=10)
#                 Label(f,text=MyText,fg='white', bg='gray',width=20).place(x=10,y=30)
#                 SpeakText("Did you say")
#                 SpeakText(MyText)
#         except sr.RequestError as e:
#             print("Could not request results; {0}".format(e))
...
#             SpeakText("unable to listen")
    ...
    mic=PhotoImage(file = r"3f41c207e196930f70d6208a31fac11c.png")
    mic1=Button(f, image=mic, compound = TOP,width=50,height=50,bg="black",border=0,activebackground="black",command=voice)
    mic1.image=mic
    mic1.place(x=1225,y=625)
...
def bill():
    ...
    bil.state('zoomed')
    bil.iconphoto(False, PhotoImage(file=r"download.png"))
    bil.resizable(0,0)
    bil.focus_set()
    ...
    receipt.insert(END,"\t\t\t                 D E L I C I O S A,\n")
    receipt.insert(END,"\t\t\t           691 8th Adnan St, Karachi,\n")
    receipt.insert(END,"\t\t\t\t        NY, 10036\n")
    receipt.insert(END,"\t\t\t            TEL: +92 382968850\n\n")
    receipt.insert(END," Name :\t\t"+entry1.get()+"\n")
    receipt.insert(END," Phone :\t\t"+entry2.get()+"\n")
    ...
    if(bc1==1):
        ...
        location=["gulshan-e-iqbal block 5","gulshan-e-iqbal block 5","gulshan-e-iqbal block 5",   #2
                  "gulshan-e-iqbal block 6","gulshan-e-iqbal block 6","gulshan-e-iqbal block 6",   #3
                  "gulshan-e-iqbal block 7","gulshan-e-iqbal block 7","gulshan-e-iqbal block 7",   #4
                  "clifton","clifton","clifton",                                                   #0
                  "defence","defence","defence",                                                   #1
                  "zamzama","zamzama","zamzama"]                                                   #5
        ...
        quantity=[2,3,5,                                                                           #2=0 
                  ...
                  2,3,5,
                  2,3,5]
        time=[15,20,30,                                                                           #block5
              20,24,30,                                                                           #block6
              30,35,40,                                                                           #block7
              40,40,90,                                                                           #clifton
              45,45,60,                                                                           #defence
              40,50,60]                                                                           #zamzam
        pd.DataFrame({"m":[7,8,9,0],"p":[9,77,0,2]})

        le=preprocessing.LabelEncoder();

        location_encoded=le.fit_transform(location)
        quantity_encoded=le.fit_transform(quantity)
        time_encoded=le.fit_transform(time)
        print(location_encoded)
        print(quantity_encoded)
        print(time_encoded)


        features=list(zip(location_encoded,quantity_encoded))
        model=KNeighborsClassifier(n_neighbors=3)
        model.fit(features,time)
        
        inputlocation=entry3.get()
        print(inputlocation)
        if inputlocation=="gulshan-e-iqbal block 5":
            inputlocation_encoded=2
        elif inputlocation=="gulshan-e-iqbal block 6":
            inputlocation_encoded=3
        elif inputlocation=="gulshan-e-iqbal block 7":
            inputlocation_encoded=4
        elif inputlocation=="clifton":
            inputlocation_encoded=0
        elif inputlocation=="defence":
            inputlocation_encoded=1
        elif inputlocation=="zamzama":
            inputlocation_encoded=5
        print("encoded location",inputlocation_encoded)
        print("encoded quantity",q)


        predicated=model.predict([[inputlocation_encoded,q]])
        print(predicated)
        receipt.insert(END," Estimated delivery= ")
        receipt.insert(END,predicated[0])
        receipt.insert(END," minutes\n")
        receipt.insert(END,"========================================================================")
    
    photo10 = PhotoImage(file = r"exit.png")
    b10=Button(bil, image = photo10, font=('LITHOGRAPH',20,'bold'), compound = TOP, command=ex)
    b10.image=photo10
    b10.place(x=1160,y=15)
    
    photoy=PhotoImage(file = r"delveryman.png")
    back=Label(bil, image=photoy,bg="black")
    back.image=photoy
    back.place(x=500,y=100) 
    ...
    def speak(word):
        engine.say(word)
        engine.runAndWait()
#     t=threading.Thread(target=speak("Your Estimated delivery time is "))
# #     t.start()
#     t=threading.Thread(target=speak(predicated))
# #     t.start()
#     t=threading.Thread(target=speak("minutes") )
#     t.start()
...
def mp():
    ...
    helpmenu.add_command(label='About...',command=about)
    w.title("AI Based Food Ordering System")
    Button(w,text="O r d e r",font=('Vivaldi',20),height=1,width=11,bd=6,fg='white', bg='brown',command=fun).place(x=580,y=600)
